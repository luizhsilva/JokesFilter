...
public class Filter {
	...
	private ArrayList<String> initInappWords() {
		...
		inappWords.add(" genital"); inappWords.add(" cunt");
		inappWords.add(" gay"); 
		...
		inappWords.add(" nigger "); inappWords.add(" jigaboo ");
		...
		inappWords.add(" ass");
		inappWords.add(" beaner ");
		inappWords.add(" bitch");
		inappWords.add(" camel toe ");
